angular.module("rubedoBlocks").lazy.controller("OrdersListController",['$scope','$compile','RubedoProductsService',"$route","RubedoContentTypesService","RubedoContentsService","RubedoPagesService",function($scope,$compile,RubedoProductsService,$route,RubedoContentTypesService,RubedoContentsService,RubedoPagesService){
    var me = this;
    me.contentList=[];
