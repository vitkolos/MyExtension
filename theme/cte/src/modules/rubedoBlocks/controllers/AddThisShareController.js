angular.module("rubedoBlocks").lazy.controller('AddThisShareController',['$scope','$timeout','$location',function($scope,$timeout,$location){
    var me = this;
    ...
    $timeout(function() {
        ...
        addthis.toolbox('.addthis_sharing_toolbox').init();
