angular.module("rubedoBlocks").lazy.controller("ContentContributionController", ["$scope", "RubedoContentsService", "RubedoContentTypesService", "$location", "$route", "RubedoPagesService", '$http', function ($scope, RubedoContentsService, RubedoContentTypesService, $location, $route, RubedoPagesService, $http) {
    var me = this;
        ...
        if (me.contentType && me.submitStatus) {
            ...
            if (me.updateMode) {
                ...
                var payLoad = {
                    ...
                    target: ["5517c04245205ec708869bc6"]
                };
                delete (formData.taxonomy);
                payLoad.fields = formData;
                ...
                //let data = { "text": "", "fields": { "text": "", "urlSegment": "", "summary": "", "image": "", "richText": "", "video": "", "author": "", "copyrights": "", "images": "", "media": "" }, "typeId": "", "status": "published", "version": "", "taxonomy": { "navigation": [] }, "online": true, "lastUpdateTime": null, "createTime": null, "startPublicationDate": null, "endPublicationDate": null, "target": ["57d124e6245640c1228b5e40"], "writeWorkspace": "57d124e6245640c1228b5e40", "pageId": "", "maskId": "", "blockId": "", "locale": "", "i18n": { "fr": { "fields": { "text": "testt", "urlSegment": "", "summary": "testt", "image": "", "richText": "<p>testt</p>\n", "video": "", "author": "", "copyrights": "", "images": "", "media": "" } } }, "nativeLanguage": "fr", "isProduct": false, "productProperties": "", "clickStreamEvent": "" }
