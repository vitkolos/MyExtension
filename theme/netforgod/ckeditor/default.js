...
{title:"Texte sur deux colonnes",image:"w33w33.png",description:"Texte sur 2 colonnes de même largeur (qui passent l'une au dessus de l'autre sur tablettes / smartphones)",
    html:'<div class="col-xs-12  col-sm-4"><p>Colonne 1 </p></div><div class="col-xs-12  col-sm-8"><p>Colonne 2 </p></div>'},
{title:"Texte sur deux colonnes inversé",image:"w33w33.png",description:"Texte sur 2 colonnes de même largeur (qui passent l'une au dessus de l'autre sur tablettes / smartphones)",
    html:'<div class="col-xs-12  col-sm-8"><p>Colonne 1 </p></div><div class="col-xs-12  col-sm-4"><p>Colonne 2 </p></div>'}
    ]});