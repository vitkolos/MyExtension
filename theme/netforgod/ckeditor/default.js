...
CKEDITOR.addTemplates("default",{imagesPath:"/theme/netforgod/ckeditor/img/",templates:[
    ...
    html:'<div class="row padding-large"><div class="col-xs-12  col-sm-6 "><p>Colonne 1 </p></div><div class="col-xs-12  col-sm-6"><p>Colonne 2 </p></div></div>'},
...
{title:"Ligne de tableau pour les dons",image:"w75w25.png",description:"Ligne de tableau pour les dons avec une bordure blanche",
    html:'<div class="row border-table"><div class="col-xs-8  col-sm-5"><p>Colonne 1 </p></div><div class="col-xs-4  col-sm-2"><p>Colonne 2 </p></div><div class="col-xs-12 col-sm-5"><p>Colonne 2 </p></div></div><p></p>'}
