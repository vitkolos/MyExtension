...
(function(){
    ...
    module.controller("RTEFieldController",['$scope','$sce',function($scope,$sce){
        ...
        var myTBConfig=[
            ...
            '/',
            { name: 'paragraph', groups: [ 'list', 'indent', 'blocks', 'align', 'bidi' ], items: [ 'NumberedList', 'BulletedList', '-', 'Outdent', 'Indent', '-', 'Blockquote','MTcollapsed', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock']},
        ...
        if (CKEMode=="Standard"){
           ...
           { name: 'paragraph', groups: [ 'list', 'indent', 'blocks', 'align', 'bidi' ], items: [ 'BulletedList', '-', 'Outdent', 'Indent', 'Blockquote','-', 'JustifyLeft', 'JustifyRight', 'JustifyBlock']},
        ...
        var editorOptions={
            ...
            extraPlugins:'rubedolink,youtube,mtcollapsed',
