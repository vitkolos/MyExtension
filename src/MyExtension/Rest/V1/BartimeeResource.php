...
class BartimeeResource extends AbstractResource
{
    ...
    public function getAction($inputs)
    {
        ...
        file_put_contents('/var/www/html/rubedo/log/custom_debug.log', date("Y-m-d H:i") . " -- BartimeeResource.php > contents query ".json_encode(get_class_methods($this->getContentsCollection()))."\n", FILE_APPEND | LOCK_EX);            
