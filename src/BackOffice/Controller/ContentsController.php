    ...
    public function createAction()
    {
        ...
        if (!is_null($data)) {
            $insertData = Json::decode($data, Json::TYPE_ARRAY);
                //check if content type has field "lieuCommunautaire" and it is not empty and has position field
            if ($insertData["fields"]["lieuCommunautaire"] && $insertData["fields"]["lieuCommunautaire"]!="" && $insertData["fields"]["position"])  {
                ...
                if($insertData["fields"]["position"]) $insertData["fields"]["position"] = $lieu["fields"]["position"]; // get its position field
            }
    ...
    public function updateAction()
    {
        ...
        if (!is_null($data)) {
            $updateData = Json::decode($data, Json::TYPE_ARRAY);
                ...
                //check if content type has field "lieuCommunautaire" and it is not empty and has position field
            if ($updateData["fields"]["lieuCommunautaire"] && $updateData["fields"]["lieuCommunautaire"]!="" && $updateData["fields"]["position"])  {
                $contentId = $updateData["fields"]["lieuCommunautaire"];
                $lieu = $this->_dataService->findById($contentId, false, false);
                if($updateData["fields"]["position"]) $updateData["fields"]["position"] = $lieu["fields"]["position"];
            }
